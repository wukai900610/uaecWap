...
<div class="body">
    <div class="pressForm-view-item" style="width: 600px; margin: 0 auto;">
        <el-form ref="form" :model="form" v-if="Addflag" :rules="rules">
            <div class="form-item">
                ...
                <div class="form-item-view">
                    ...
                    <div class="form-item-view-flex">
                        ...
                        <div class="form-item-view-flex-right">
                            <el-form-item label="中文：" prop="Address" class="form-address">
                            ...
                            <el-form-item label="邮编：" prop="PostCode">
                                <el-input v-model="form.PostCode" placeholder="邮编" type="number"></el-input>
                            </el-form-item>
                        </div>
                    </div>
                    <div class="form-item-view-flex">
                        ...
                        <div class="form-item-view-flex-right">
                            ...
                            <el-form-item label="电 话：" prop="ManMobile">
                                <el-input v-model="temp.ManMobile1" placeholder="城市区号" type="number" style="width:90px;"></el-input>
                                <el-input v-model="temp.ManMobile2" placeholder="号码" type="number" style="width:100px;"></el-input>
                                <el-input v-model="temp.ManMobile3" placeholder="分机" type="number" style="width:70px;"></el-input>
                            </el-form-item>
        ...
        <ExhibitorRules v-if="!Addflag" :sub="form" />
    </div>
</div>
</template>
...
import ExhibitorRules from './ExhibitorRules.vue';
...
export default {
    ...
    created() {
        ...
        if (this.code == undefined) {
            this.code = this.$store.getters.skin.code
        }
    },
    methods: {
        submitForm(formName) {
